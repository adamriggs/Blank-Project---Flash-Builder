		...
		arcane override function project(viewTransform:MatrixAway3D, vertices:Array, screenVertices:Array):void
        {
        	...
        	for each (_vertex in vertices) {
	            ...
	            _sz = _vx * viewTransform.szx + _vy * viewTransform.szy + _vz * viewTransform.szz + viewTransform.tz;
	           	...
	           	if (isNaN(_sz))
	                throw new Error("isNaN(sz) _vx:"+_vx+" _vy:"+_vy+" _vz:"+_vz+" viewTransform.szx:"+viewTransform.szx+" viewTransform.szy:"+viewTransform.szy+" viewTransform.szz:"+viewTransform.szz+" viewTransform.tz:"+viewTransform.tz);
	            
				
	            if (isNaN(_sz) || (_sz < _near && _clipping is RectangleClipping)) {
